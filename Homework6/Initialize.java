...
public class Initialize {
    ...
    public Initialize(JFrame frame) {
        this.frame = frame;
    }
    ...
    public void initial() {
        ...
        NumberButton btn4 = new NumberButton(textField, "4");
        frame.getContentPane().add(btn4.create());
        ...
        btnEqual.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                LoggerClass log = new LoggerClass(logger);
                if (operation == "+") {
                    result = first + second;
                ...
                log.doLog(first, second, operation, result);
            }
        });
